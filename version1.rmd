...
The result of the clustering are three most similar groups of states. The first cluster includes states like California, Florida, Nevada, the second cluster includes Hawaii, Utah, Colorado, and the third one includes Maine, Vermont, New York and Virginia. 
...
As a next step of the analysis, we map clusters to the regions of each jurisdiction. It can be seen that in case of Northeast, all states were grouped in one cluster (...)
