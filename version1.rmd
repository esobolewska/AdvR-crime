...
final_data_plot <- final_data %>% 
  mutate(
    pct_change_violent = (violent_crime_total_rate_2016-violent_crime_total_rate_2001)/abs(violent_crime_total_rate_2001)*100,
    pct_change_property = (property_crime_total_rate_2016-property_crime_total_rate_2001)/abs(property_crime_total_rate_2001)*100,
    pct_change_imprisonment = (imprisonment_rate_2016-imprisonment_rate_2001)/abs(imprisonment_rate_2001)*100) %>%
...
ggp_violent <- ggplot(data = final_data_plot, 
                      aes(x = jurisdiction, 
                          ...
                          fill=as.factor(jurisdiction), 
                          text = paste("Jurisdiction: ", jurisdiction,
                                       "<br>Percentage change:", round(pct_change_violent, 2)))) +
  geom_bar(stat='identity', position="dodge") +
  scale_y_continuous(limits=c(-50, 200), breaks=seq(-50, 200, 50), labels=percent) +
  coord_flip() +
...
ggp_imprisonment <- ggplot(data = final_data_plot,
  ...
  geom_bar(stat='identity') +
  scale_y_continuous(limits=c(-40, 40), breaks=seq(-40, 40, 10), labels=percent) +
  coord_flip() +
...
### {.tabset .tabset-fade .tabset-pills}
#### Percent change in state violent crime rates, 2001-2016
...
### {.tabset .tabset-fade .tabset-pills}
#### Percent change in state property crime rates, 2001-2016
...
### {.tabset .tabset-fade .tabset-pills}
#### Percent change in state imprisonment rates, 2001-2016
...
In order to find the relationship between investments into prisons and crime rates, we calculated the value of expenditures per prisoner and the number of crime accidents per state population. 
